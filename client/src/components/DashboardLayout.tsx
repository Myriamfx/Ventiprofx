...
const menuItems = [
  ...
  { icon: Building2, label: "Centros", path: "/centros" },
        ...
        <div className="flex flex-col gap-8 p-10 max-w-md w-full bg-white rounded-2xl shadow-xl border border-green-100">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Gestión Porcina Integral. Inicie sesión para acceder al panel de
              control.
            </p>
          </div>
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <div className="w-7 h-7 bg-gradient-to-br from-green-600 to-emerald-700 rounded-lg flex items-center justify-center shrink-0">
